...
- **トレイアイコン**は有効なウィンドウごとに表示します(Claude / Codex はリング、GitHub Copilot は縦%バー)。Copilot の縦%バーはアイコン領域を縦長に使い、当月消費の割合(プラン上限比)を示します。両ウィンドウとも OFF のときは、設定・終了に到達できるよう操作用アイコンを 1 つだけ表示します。
- **制約**:
